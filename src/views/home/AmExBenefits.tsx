  ...
  return (
    <CardContainer>
      ...
      <SliderContainer
        ...
        max={200}
        value={benefitsValuation.amex.uberCredit}
        onChange={() => { }}
      />
      <SliderContainer
        ...
        max={200}
        value={benefitsValuation.amex.airlineIncidentalPlat}
        onChange={() => { }}
      />
      <SliderContainer
        ...
        max={100}
        value={benefitsValuation.amex.saksCredit}
        onChange={() => { }}
      />
      <SliderContainer
        ...
        max={100}
        value={benefitsValuation.amex.tsaGlobalEntryCredit}
        onChange={() => { }}
      />
      <SliderContainer
        ...
        max={100}
        value={benefitsValuation.amex.loungeAccess}
        onChange={() => { }}
      />
      ...
      <SliderContainer
        ...
        max={1000}
        value={benefitsValuation.amex.hotelStatus}
        onChange={() => { }}
      />
      <SliderContainer
        ...
        max={120}
        value={benefitsValuation.amex.diningCredit}
        onChange={() => { }}
      />
      <SliderContainer
        ...
        max={200}
        value={benefitsValuation.amex.airlineIncidentalGold}
        onChange={() => { }}
      />
    </CardContainer>
  );
